        ...
        <div class="container p-3 my-3">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                                ...
                                <form action="concerns.php" method="get" class="p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 mb-2">
                                            ...
                                            <input class="inputField form-control form-control-sm" type="text" value="<?php echo $EmpName; ?>" readonly>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 mb-2">
                                ...
                                <form action="pdf/print_concerns.php" method="post" enctype="multipart/form-data">
                                    <div class="p-4">
                                        <div class="row">
                                            ...
                                            ?>
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <label><small>Attachment (<span class="text-danger" style="font-weight: bold;">HYO FORM</span>)</small></label><br>
                                                    <?php
                                                    // Determine type_concern based on $getConcern
                                                    if ($getConcern == "Remove Time Inputs") {
                                                        $type_concern = 6;
                                                    }

                                                    // Query to check if the requirements are already submitted and get the type_concern
                                                    $querySubmitted = "SELECT COUNT(*) AS submission_count, type_concern
                                                    FROM hear_you_out
                                                    WHERE empno = '$empno'
                                                    AND date_submitted = '$cdate'
                                                    AND type_concern = $type_concern";

                                                    $querySub = $HRconnect->query($querySubmitted);
                                                    $row_sub = $querySub->fetch_array();

                                                    // Check if the query returned a result
                                                    $submission_count = isset($row_sub['submission_count']) ? $row_sub['submission_count'] : 0;

                                                    // Check if the employee has already submitted the requirements
                                                    if ($submission_count > 0 && $row_sub['type_concern'] == $type_concern) {
                                                        // If already submitted, show the link to view the form in view-only mode
                                                        echo '<a href="/hrms/hear-you-out-view-only.php?empno=' . urlencode($empno) . '&type_concern=' . urlencode($type_concern) . '&ConcernDate=' . urlencode($cdate) . '" target="_blank" style="font-weight: bold; text-decoration: underline; color: gray; font-size: 18px;">Already Submitted HYO<br>Click to Review Form</a>';
                                                    } else {
                                                        // If not submitted, enable the link and show the normal text
                                                        echo '<a href="/hrms/hear-you-out.php?empno=' . urlencode($empno) . '&name=' . urlencode($EmpName) . '&position=' . urlencode($position) . '&ConcernDate=' . urlencode($cdate) . '&type_concern=' . urlencode($type_concern) . '&Concern=' . urlencode($getConcern) .  '" style="font-weight: bold; text-decoration: underline; font-size: 18px;">Click here to create.</a>';
                                                    }
                                                ...
                                                <div class="col-xl-12 col-lg-12 mt-2">
                                                    ...
                                                    <label class="form-check-label ml-4" for="exampleCheck1"><em><small>I hereby certify that the above infomation provided is correct.
                                    ...
                                    <div class="d-flex flex-row-reverse mt-3">
                                        <div class="p-1">
                                            ...
                                            $Name = $row8['name'];
                                            ?>
                                            <input type="hidden" name="isSubmitHYO" value="<?php echo $submission_count; ?>" required>
                                            ...
                                            <input type="submit" id="submitButton" class="btn btn-sm border-0 btn-primary mr-2 mb-2" style="font-weight: bold;" value="Submit" name="submit" onclick="return confirm('Are you sure you want to submit your DTR concern?');" <?php if ($submission_count == 0 || is_null($submission_count)) echo 'disabled'; ?>>
                                        </div>
                                    </div>
                        </div>
                        </form>
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        <div class="col-xl-6 col-lg-6">
                                            ...
                                            <br>
                                            <label>
                                                <bold><?php echo $mindate; ?> to <?php echo $maxdate; ?></bold>
                                            </label>
                    ...
                    ?>
                        <div>
                            <label style="padding-left: 23px; color:blue;">
                            ...
                            <div class="p-4">
                                <div class="row">
                                    ...
                                    ?>
                                        <div class="col-xl-6 col-lg-6">
                                            ...
                                            <input type="hidden" id="othours" name="othours" value=" ">
                                            <input type="hidden" id="otdate" name="otdate" value=" ">
                                            <input class="inputField form-control form-control-sm mb-1" type="text" id="actualIN" name="actualIN" value="<?php if ($row7['M_timein'] != '') {
                                            ...
                                            <input class="inputField form-control form-control-sm mb-1" type="text" id="actualbrkOUT" name="actualbrkOUT" value="<?php if ($row7['M_timeout'] == 'No Break') {
                                                                                                                                                            echo $row7['M_timeout'];
                                            ...
                                            <input class="inputField form-control form-control-sm mb-1" type="text" id="actualbrkIN" name="actualbrkIN" value="<?php if ($row7['A_timein'] == 'No Break') {
                                                                                                                                                        echo $row7['A_timein'];
                                            ...
                                            <input class="inputField form-control form-control-sm mb-1" type="text" id="actualOUT" name="actualOUT" value="<?php if ($row7['A_timeout'] != '') {
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            ...
                                            <input class="inputField form-control form-control-sm mb-1" type="text" pattern="([01]?[0-9]{1}|2[0-3]{1}):[0-5]{1}[0-9]{1}" placeholder="00:00" value="<?php if ($row7['M_timein'] != '') {
                                                                                                                                                                                                echo date('H:i', strtotime($row7['M_timein']));
                                                                                                                                                                                            } else if ($row7['M_timein'] == '') {
                                                                                                                                                                                                echo '';
                                                                                                                                                                                            } ?>" name="newIN" required>
                                            <input class="inputField form-control form-control-sm mb-1" type="text" value="No Break" name="newbrkOUT" id="newbrkOUT" readonly>
                                            <input class="inputField form-control form-control-sm mb-1" type="text" value="No Break" name="newbrkIN" id="newbrkIN" readonly>
                                            <input class="inputField form-control form-control-sm mb-1" type="text" pattern="([01]?[0-9]{1}|2[0-3]{1}):[0-5]{1}[0-9]{1}" placeholder="00:00" value="<?php if ($row7['A_timeout'] != '') {
                                                                                                                                                                                                echo date('H:i', strtotime($row7['A_timeout']));
                                                                                                                                                                                            } else if ($row7['A_timeout'] == '') {
                                                                                                                                                                                                echo '';
                                        ...
                                        <div class="col-xl-6 col-lg-6 mt-2">
                                            ...
                                            FROM hear_you_out
                                            WHERE empno = '$empno'
                                            AND date_submitted = '$cdate' AND type_concern = 1";
                                            $querySub = $HRconnect->query($querySubmitted);
                                            $row_sub = $querySub->fetch_array();

                                            // Check if the query returned a result
                                            $submission_count = isset($row_sub['submission_count']) ? $row_sub['submission_count'] : 0;
                                            $type_concern = isset($row_sub['type_concern']) ? $row_sub['type_concern'] : '';

                                            // Check if the employee has already submitted the requirements
                                            if ($submission_count > 0 && $type_concern == 1) {
                                                // If already submitted, show the link to view the form in view-only mode
                                                echo '<a href="/hrms/hear-you-out-view-only.php?empno=' . urlencode($empno) . '&type_concern=' . urlencode($type_concern) . '&ConcernDate=' . urlencode($cdate) . '" target="_blank" style="font-weight: bold; text-decoration: underline; color: gray; font-size: 18px;">Already Submitted HYO<br>Click to Review Form</a>';
                                            } else {
                                                // If not submitted, enable the link and show the normal text
                                        ...
                                        <div class="col-xl-12 col-lg-12 mt-2">
                                            ...
                                            <div class="form-check mb-1 ml-1">
                                                ...
                                                <label class="form-check-label" for="exampleCheck1">
                                                    <em><small>I hereby certify that the above information provided is correct. Any falsification of information in this regard may form ground for disciplinary action up to and including dismissal.</em></small>
                                                </label>
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="d-flex flex-row-reverse mt-3">
                                    <div class="p-1">
                                        ...
                                        <input type="hidden" name="filed" value="done">
                                        <input type="hidden" name="d" value="2">
                                        <input type="submit" id="submitButton" class="btn btn-sm border-0 btn-primary" style="font-weight: bold;" value="Submit" name="submit" onclick="return confirm('Are you sure you want to submit your DTR concern?');" <?php if ($submission_count == 0 || is_null($submission_count)) echo 'disabled'; ?>>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <form action="pdf/print_concerns.php" method="post" enctype="multipart/form-data">
                            <div class="p-4">
                                <div class="row">
                                    ...
                                    ?>
                                        <center>
                                            <p><i><b class="text-danger">Note!</b> always remember that our system is using millitary time please use correct time format (<b class="text-success"> 00:00</b> ) to prevent errors.</p></i>
                                        </center>
                                        ...
                                        <div class="col-xl-6 col-lg-6 mb-0">
                                            ...
                                            <input class="inputField form-control form-control-sm mb-1" type="text" id="actualIN" name="actualIN" value="<?php if ($row7['timein4'] != '') {
                                            ...
                                            <input class="inputField form-control form-control-sm mb-1" type="text" id="actualOUT" name="actualOUT" value="<?php if ($row7['timeout4'] != '') {
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            ...
                                            <br>
                                            <small>Broken Sched IN: </small>
                                            <input class="inputField form-control form-control-sm mb-1" type="text" pattern="([01]?[0-9]{1}|2[0-3]{1}):[0-5]{1}[0-9]{1}" placeholder="00:00" value="<?php if ($row7['timein4'] != '') {
                                                                                                                                                                                                echo date('H:i', strtotime($row7['timein4']));
                                                                                                                                                                                            } else if ($row7['timein4'] == '') {
                                                                                                                                                                                                echo '';
                                                                                                                                                                                            } ?>" name="newIN" required>
                                            <small>Broken Sched OUT: </small>
                                            <input class="inputField form-control form-control-sm mb-1" type="text" pattern="([01]?[0-9]{1}|2[0-3]{1}):[0-5]{1}[0-9]{1}" placeholder="00:00" value="<?php if ($row7['timeout4'] != '') {
                                                                                                                                                                                                echo date('H:i', strtotime($row7['timeout4']));
                                                                                                                                                                                            } else if ($row7['timeout4'] == '') {
                                                                                                                                                                                                echo '';
                                                                                                                                                                                            } ?>" name="newOUT" required>
                                        ...
                                        <div class="col-xl-6 col-lg-6 mt-2">
                                            ...
                                            FROM hear_you_out
                                            WHERE empno = '$empno'
                                            AND date_submitted = '$cdate' AND type_concern = 2";
                                            $querySub = $HRconnect->query($querySubmitted);
                                            $row_sub = $querySub->fetch_array();
                                            ...
                                            // Check if the employee has already submitted the requirements
                                            if ($submission_count > 0 && $type_concern == 2) {
                                                // If already submitted, show the link to view the form in view-only mode
                                                echo '<a href="/hrms/hear-you-out-view-only.php?empno=' . urlencode($empno) . '&type_concern=' . urlencode($type_concern) . '&ConcernDate=' . urlencode($cdate) . '" target="_blank" style="font-weight: bold; text-decoration: underline; color: gray; font-size: 18px;">Already Submitted HYO<br>Click to Review Form</a>';
                                            } else {
                                                // If not submitted, enable the link and show the normal text
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        ...
                                        <div class="col-xl-12 col-lg-12 mb-1">
                                            <center>
                                                <p><i><b class="text-danger">Note!</b> always remember to input the correct ot hours before clicking submit. Thank you! </p></i>
                                            </center>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 mb-1">
                                            ...
                                            <select class="inputField form-control form-control-sm mb-1" id="ottype" name="ottype" required>
                                            ...
                                            <input type="number" class="inputField form-control form-control-sm text-center" name="othours" placeholder="Number of OT Hours" max="<?php echo $maxot; ?>" min="<?php if ($maxot == 0) {
                                                                                                                                                                                                        echo $maxot;
                                                                                                                                                                                                    } else {
                                                                                                                                                                                                        echo 1;
                                                                                                                                                                                                    } ?>" required>
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                            ...
                                            <div class="col-xl-6 col-lg-6 mb-1">
                                                ...
                                                <input class="inputField form-control form-control-sm mb-1" type="text" pattern="([01]?[0-9]{1}|2[0-3]{1}):[0-5]{1}[0-9]{1}" placeholder="00:00" value="<?php if ($row7['M_timeout'] == 'No Break') {
                                                                                                                                                                                                    echo $row7['M_timeout'];
                                                                                                                                                                                                } else if ($row7['M_timeout'] != '') {
                                                                                                                                                                                                    echo date('H:i', strtotime($row7['M_timeout']));
                                                                                                                                                                                                } else if ($row7['M_timeout'] == '' or $row7['M_timeout'] != 'No Break') {
                                                ...
                                                <input class="inputField form-control form-control-sm mb-1" type="text" pattern="([01]?[0-9]{1}|2[0-3]{1}):[0-5]{1}[0-9]{1}" placeholder="00:00" value="<?php if ($row7['A_timein'] == 'No Break') {
                                                                                                                                                                                                    echo $row7['A_timein'];
                                                                                                                                                                                                } else if ($row7['A_timein'] != '') {
                                            ...
                                            FROM hear_you_out
                                            WHERE empno = '$empno'
                                            AND date_submitted = '$cdate' AND type_concern = 5";
                                                $querySub = $HRconnect->query($querySubmitted);
                                                $row_sub = $querySub->fetch_array();
                                                ...
                                                // Check if the employee has already submitted the requirements
                                                if ($submission_count > 0 && $type_concern == 5) {
                                                    // If already submitted, show the link to view the form in view-only mode
                                                    echo '<a href="/hrms/hear-you-out-view-only.php?empno=' . urlencode($empno) . '&type_concern=' . urlencode($type_concern) . '&ConcernDate=' . urlencode($cdate) . '" target="_blank" style="font-weight: bold; text-decoration: underline; color: gray; font-size: 18px;">Already Submitted HYO<br>Click to Review Form</a>';
                                                } else {
                                                    // If not submitted, enable the link and show the normal text
                                            ...
                                            <div class="form-check mb-1 ml-1 mt-5">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck1" required>
                                                <label class="form-check-label" for="exampleCheck1"><em><small>I hereby certify that the above infomation provided is correct.
                                                            Any falsification of information in this regard may form ground for
                                                            disciplinary action up to and including dismissal.</em></small>
                            ...
                            <div class="a-form p-4">
                                <div class="row">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <label class="mt-2"><small>Attachment 2(<span class="text-danger"> LOGS HISTORY PICTURE </span>)</small></label><br>
                                                <small><input type="file" accept="image/*,video/*" name="attachment2" required /></small>
                                            </div>
                                            <label for="exampleFormControlTextarea1" required><small>Reason</small></label>
                                            <input type="text" class="form-control form-control-sm" pattern="^[-@.\/#&+\w\s]*$" placeholder="Input Reason" id="exampleFormControlTextarea1" name="concernReason" required>
                                        <?php
                                        } else {
                                        ?>
                                            <div class="col-xl-6 col-lg-6 mt-2">
                                                ...
                                                <?php
                                                // Determine type_concern based on $getConcern
                                                if ($getConcern == "Forgot/Wrong time IN/OUT or break OUT/IN") {
                                                    $type_concern = 3;
                                                } elseif ($getConcern == "Not following time interval") {
                                                    $type_concern = 4;
                                                }
                                ...
                                <div class="d-flex flex-row-reverse mt-3">
                                    <div class="p-1">
                                        ...
                                        <input type="hidden" name="filed" value="done">
                                        <input type="hidden" name="d" value="2">
                                        <input type="submit" class="btn btn-sm border-0 btn-primary mr-2 mb-2" value="Submit" name="submit" onclick="return confirm('Are you sure you want to submit your dtr concern?');">
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <script type='text/javascript'>
        document.querySelectorAll('.inputField').forEach(function(input) {
            input.addEventListener('input', function() {
                // Replace any character that is not a digit or colon with an empty string
