                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ...
                                if (
                                    $userlevel == 'ac' and $_SESSION['empno'] == 71 or $_SESSION['empno'] == 1964 or $_SESSION['empno'] == 3294 or $_SESSION['empno'] == 3107 or $_SESSION['empno'] == 3336 or $_SESSION['empno'] == 3111
                        ...
                        <?php
                        if (
                            $userlevel == 'master' or $userlevel == 'admin' and $_SESSION['empno'] != 1348 and $_SESSION['empno'] != 271 or $userlevel == 'ac' and $_SESSION['empno'] != 71 and $_SESSION['empno'] != 1964 and $_SESSION['empno'] != 3294 and $_SESSION['empno'] != 3107 and $_SESSION['empno'] != 2221 and $_SESSION['empno'] != 3336 and $_SESSION['empno'] != 3111
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ...
                                if (
                                    $_SESSION['empno'] == 271 or $userlevel == 'ac' and $_SESSION['empno'] == 71 or $_SESSION['empno'] == 1964 or $_SESSION['empno'] == 3294 or $_SESSION['empno'] == 3107 or $_SESSION['empno'] == 3336 or $_SESSION['empno'] == 3111
                                    or $_SESSION['empno'] == 159 or $_SESSION['empno'] == 3235 or $_SESSION['empno'] == 3027
                                ) {
                                    echo $Totalpendingvl;
                                }
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ...
                                if ($userlevel == 'master') {
                                    ...
                                    $sql0 = "SELECT COUNT(*) FROM dtr_concerns WHERE status = 'Pending' AND empno in(1348,1964,2957,4349,2111,2243,3332,3693,4000) AND concern IN ('$emergency', '$FPError', '$BrokenOT','$forgot1', '$forgot2', '$forgot3', '$forgot4', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                } else if ($_SESSION['empno'] == 1331) {
                                    $sql0 = "SELECT COUNT(*) FROM dtr_concerns WHERE status = 'Pending' AND empno in(819,109,76,71,167) AND concern IN ('$emergency', '$BrokenOT','$FPError', '$forgot1', '$forgot2', '$forgot3', '$forgot4', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                    ...
                                    $sql0 = "SELECT COUNT(*) FROM dtr_concerns WHERE status = 'Pending' AND userid in (166,173,165) AND concern IN ('$emergency', '$FPError','$BrokenOT', '$forgot1', '$forgot2', '$forgot3', '$forgot4', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                    ...
                                    $sql0 = "SELECT COUNT(*) FROM dtr_concerns WHERE status = 'Pending' AND empno in(38,112,254,302) AND concern IN ('$emergency', '$BrokenOT','$FPError', '$forgot1', '$forgot2', '$forgot3', '$forgot4', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                    ...
                                    $sql0 = "SELECT COUNT(*) FROM dtr_concerns WHERE status = 'Pending' AND userid = '$userid' AND concern IN ('$emergency','$BrokenOT', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$forgot4', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                } else if ($_SESSION['empno'] == 3107) {
                                    $sql0 = "SELECT COUNT(*) FROM dtr_concerns WHERE status = 'Pending' AND empno in(3167,1075,957,884) AND concern IN ('$emergency', '$FPError', '$BrokenOT','$forgot1', '$forgot2', '$forgot3', '$forgot4', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                    ...
                                    $sql0 = "SELECT COUNT(*) FROM dtr_concerns WHERE status = 'Pending' AND empno in(401,3780,4814) AND concern IN ('$emergency', '$FPError', '$BrokenOT','$forgot1', '$forgot2', '$forgot3', '$forgot4', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                } else if ($_SESSION['empno'] == 2221) {
                                    $sql0 = "SELECT COUNT(*) FROM dtr_concerns WHERE status = 'Pending' AND empno in(1262) AND concern IN ('$emergency', '$FPError', '$BrokenOT','$forgot1', '$forgot2', '$forgot3', '$forgot4', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                } else {
