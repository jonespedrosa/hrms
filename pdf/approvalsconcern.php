                                ...
                                <table class="table table-bordered table-hover text-uppercase table-sm" id="example2" width="100%" cellspacing="0">
									<thead>
                                        <tr class="bg-gray-200">																												
											...
											<th><center>Type of Error</center></th>
                            		...
                            		if($userlevel == 'master'){
                                        ...
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(107) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 4378){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(1348,1964,6082,2957,4349) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 1331){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(819,109,76,71,167,3183) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 1073){    
                                         $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND userid in (3,168) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' ) OR empno = 1844 AND empno != 1073 AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
            
                                    }else if($_SESSION['empno'] == 4298){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND userid in (171,172) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 3178){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND userid in (170) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 2684){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND userid in (166,165,232) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 3071){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(2203,2264) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2')  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 76){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(37,53,45,69,124,2720) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' ) AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 37 || $_SESSION['empno'] == 53 || $_SESSION['empno'] == 45 || $_SESSION['empno'] == 69 || $_SESSION['empno'] == 124 || $_SESSION['empno'] == 2720 ){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' ) AND area = 'SOUTH' AND userlevel = 'mod' AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 109){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(63,88,97,170) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 63 || $_SESSION['empno'] == 88 || $_SESSION['empno'] == 97 || $_SESSION['empno'] == 170 ){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' ) AND area = 'MFO' AND userlevel = 'mod' AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 819){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(38,112,254,302,4484,1562,4709,204) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 38 || $_SESSION['empno'] == 112 || $_SESSION['empno'] == 254 || $_SESSION['empno'] == 302){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' ) AND area = 'NORTH' AND userlevel = 'mod' AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 71){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND userid = '$userid' AND empno in(309,197,158,4209) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 5928){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(3167,1075,5928,884) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";

                                    }else if($_SESSION['empno'] == 3235){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(159) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";    

                                    }else if($_SESSION['empno'] == 3336){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(401,3780,4814) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";  
                                    }else if($_SESSION['empno'] == 2221){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(1262) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";  
                                    }else if($_SESSION['empno'] == 24){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(819,109,76,71,167) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                    }else if($_SESSION['empno'] == 1844){
                                        $sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND empno in(2485) AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' )  AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
                                    }else{
                                    	$sql = "SELECT * FROM dtr_concerns WHERE status = 'Pending' AND userid = '$userid' AND concern IN ('$emergency', '$FPError', '$forgot1', '$forgot2', '$forgot3', '$wrong', '$timeInterval', '$removeLogs', '$cancel1', '$cancel2' ) AND userlevel = 'mod' AND ConcernDate BETWEEN '$datestart' AND '$dateend'";
										...
										?>									
											<tr>											
												...
												<td><center><?php echo $row['ConcernDate']; ?></center></td>
												<td><center><?php echo $row['concern']; ?></center></td>
												<td><center><?php echo $row['errortype']; ?></center></td>
												<td><center><?php echo $row['reason']; ?></center></td>
												<td><center><?php echo $row['status']; ?></center></td>
												<td><center><a href="viewconcerns.php?dtrconcerns=<?php echo $row['concern']; ?>&dtr=concerns&empno=<?php echo $row['empno']; ?>&date=<?php echo $row['ConcernDate']; ?>&ml=1" class="btn btn-info btn-user btn-sm btn-block bg-gradient-info">Details</a></center></td>								
											</tr>										
									<?php
										}
										?>	
									...
									if($userlevel == 'master'){
										...
										?>
											...
											<tr>
												...
												<td><center><?php echo $department; ?></center></td>	
												<td><center><?php echo $row0['empno']; ?></center></td>
												<td><center><?php echo html_entity_decode(htmlentities($name)); ?></center></td>
												<td><center><?php echo $row0['ConcernDate']; ?></center></td>
												<td><center><?php echo $row0['concern']; ?></center></td>
												<td><center><?php echo $row0['ottype']; ?></center></td>
												<td><center><?php echo $row0['reason']; ?></center></td>
												<td><center><?php echo $row0['status']; ?></center></td>
												<td><center><a href="viewconcerns.php?dtrconcerns=<?php echo $row0['concern']; ?>&dtr=concerns&empno=<?php echo $row0['empno']; ?>&date=<?php echo $row0['ConcernDate']; ?>&ml=1" class="btn btn-info btn-user btn-sm btn-block bg-gradient-info">Details</a></center></td>								
											</tr>										
									<?php
										}
										}
