	...
	<div class="col-12">
		...
		<div class="table-responsive">
			<table class="myTable">
                ...
                ?>
					<tr>
						<td><center><?php echo $row5['ConcernDate']; ?><center></td>
						<td><center><?php echo $row5['concern']; ?><center></td>
						<td><center><?php echo $row5['errortype']; ?><center></td>
						<td><center><?php echo $row5['newIN']; ?><center></td>
						<td><center><?php echo $row5['newbOUT']; ?></center></td>
						<td><center><?php echo $row5['newbIN']; ?></center></td>
